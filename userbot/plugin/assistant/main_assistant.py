    ...
    if event.sender_id == bot.uid:
        ...
        await tgbot.send_message(
            ...
            buttons=[
                ...
                [Button.url("Help Me ❓", "https://t.me/King_bot_official")],
            ],
        )
...
async def help(event):
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                [Button.url("Deploy Tutorial 📺", "https://t.me/King_bot_official")],
                [Button.url("Need Help ❓", "https://t.me/King_bot_officialchat")],
            ],
        )
