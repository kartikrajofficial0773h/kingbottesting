...
pm_caption += "➥ **License** : [GNU General Public License v3.0](github.com/kartikrajofficial0773h/KINGBOT)\n"
pm_caption += "➥ **Copyright** : By [KINGBOT](https://t.me/King_bot_officialchat)\n"
