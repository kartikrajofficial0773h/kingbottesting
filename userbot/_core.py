...
DELETE_TIMEOUT = 3
thumb_image_path = "./Resources/photo_2021-01-16_09-31-46.jpg"
...
async def unload(event):
    ...
    try:
        ...
        qwe = await eor(event, f"KINGBOT Has Successfully unloaded {shortname}")
    except Exception as e:
        await qwe.edit(
            "KINGBOT has Successfully unloaded {shortname}\n{}".format(shortname, str(e))
        )
...
async def load(event):
    ...
    try:
        ...
        await qwe.edit(
            f"Kingbot could not load {shortname} because of the following error.\n{str(e)}"
        )
